...
● 5.0.6 ● Spring?s Aspect-Oriented Programming (AOP) 
● Spring Web MVC 
● Spring WebFlux ^5.0 - http://www.reactive-streams.org - SPEC (https://github.com/reactive-streams/reactive-streams-jvm)
